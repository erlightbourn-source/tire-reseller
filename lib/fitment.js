...
export const FITMENT = {
  ...
  Chevrolet: {
    ...
    Trax: {
      "LS / LT": [{ from: 2024, to: 2025, size: "205/60R17" }],
      "RS / Activ": [{ from: 2024, to: 2025, size: "225/55R18" }],
    },
    Trailblazer: {
      "LS / LT": [{ from: 2021, to: 2025, size: "215/60R17" }],
      "RS / ACTIV": [{ from: 2021, to: 2025, size: "225/55R18" }],
    },
    "Bolt EV / EUV": {
      "Base / LT": [{ from: 2022, to: 2025, size: "215/50R17" }],
    },
  },
  GMC: {
    "Sierra 1500": {
  ...
  Nissan: {
    ...
    Maxima: {
      "SV / SL": [{ from: 2016, to: 2023, size: "245/45R18" }],
      "SR / Platinum": [{ from: 2016, to: 2023, size: "245/40R19" }],
    },
    Leaf: {
      "S / SV": [{ from: 2018, to: 2025, size: "215/50R17" }],
    },
  },
  Jeep: {
    Renegade: {
  ...
  Hyundai: {
    ...
    "Ioniq 6": {
      "SE / SEL": [{ from: 2023, to: 2025, size: "225/55R19" }],
      "Limited": [{ from: 2023, to: 2025, size: "245/40R20" }],
    },
  },
  Kia: {
    Forte: {
  ...
  BMW: {
    ...
    "8 Series": {
      "840i": [{ from: 2019, to: 2025, size: "245/40R19", rear: "275/35R19" }],
      "M850i": [{ from: 2019, to: 2025, size: "245/35R20", rear: "275/30R20" }],
    },
    i4: {
      "eDrive40": [{ from: 2022, to: 2025, size: "245/45R18" }],
      "M50": [{ from: 2022, to: 2025, size: "255/45R19", rear: "285/40R19" }],
    },
    Z4: {
      "sDrive30i": [{ from: 2019, to: 2025, size: "225/45R18", rear: "255/40R18" }],
      "M40i": [{ from: 2019, to: 2025, size: "255/40R18", rear: "275/35R19" }],
    },
  },
  "Mercedes-Benz": {
    "A-Class": {
  ...
  Genesis: {
    G70: {
      "2.5T / 3.3T": [{ from: 2019, to: 2025, size: "225/45R18" }],
      "Sport / Prestige": [{ from: 2019, to: 2025, size: "225/40R19", rear: "255/35R19" }],
    },
    G80: {
      "2.5T": [{ from: 2021, to: 2025, size: "245/45R19" }],
      "3.5T Sport": [{ from: 2021, to: 2025, size: "245/40R20", rear: "275/35R20" }],
    },
    G90: {
      "3.5T": [{ from: 2023, to: 2025, size: "245/45R19" }],
      "3.5T E-SC": [{ from: 2023, to: 2025, size: "245/40R20", rear: "275/35R20" }],
    },
    GV70: {
      "2.5T": [{ from: 2022, to: 2025, size: "235/60R18" }],
      "3.5T Sport": [{ from: 2022, to: 2025, size: "265/45R21" }],
    },
    GV80: {
      "2.5T": [{ from: 2021, to: 2025, size: "265/50R20" }],
      "3.5T": [{ from: 2021, to: 2025, size: "275/45R21" }],
    },
  },
  Infiniti: {
    Q50: {
      "Luxe / Pure": [{ from: 2014, to: 2024, size: "225/55R17" }],
      "Red Sport 400": [{ from: 2016, to: 2024, size: "245/40R19", rear: "265/35R19" }],
    },
    Q60: {
      "Pure / Luxe": [{ from: 2017, to: 2022, size: "225/55R18" }],
      "Red Sport 400": [{ from: 2017, to: 2022, size: "255/35R20", rear: "275/35R20" }],
    },
    QX50: {
      "Pure / Luxe": [{ from: 2019, to: 2025, size: "235/55R19" }],
      "Sensory / Autograph": [{ from: 2019, to: 2025, size: "255/45R20" }],
    },
    QX60: {
      "Pure / Luxe": [{ from: 2022, to: 2025, size: "235/60R18" }],
      "Sensory / Autograph": [{ from: 2022, to: 2025, size: "255/45R20" }],
    },
    QX80: {
      "Luxe": [{ from: 2018, to: 2025, size: "265/60R18" }],
      "Premium / Sensory": [{ from: 2018, to: 2025, size: "275/50R22" }],
    },
  },
  Lincoln: {
    Corsair: {
      "Standard / Premiere": [{ from: 2020, to: 2025, size: "245/50R19" }],
      "Reserve / Grand Touring": [{ from: 2020, to: 2025, size: "245/45R20" }],
    },
    Nautilus: {
      "Standard / Reserve": [{ from: 2019, to: 2025, size: "255/55R19" }],
      "Reserve / Black Label": [{ from: 2019, to: 2025, size: "265/45R21" }],
    },
    Aviator: {
      "Standard / Reserve": [{ from: 2020, to: 2025, size: "255/55R20" }],
      "Black Label": [{ from: 2020, to: 2025, size: "275/40R22" }],
    },
    Navigator: {
      "Reserve": [{ from: 2018, to: 2025, size: "285/45R22" }],
      "Black Label": [{ from: 2018, to: 2025, size: "285/45R22" }],
    },
  },
  Buick: {
    "Encore GX": {
      "Preferred / Sport Touring": [{ from: 2020, to: 2025, size: "215/55R18" }],
      "Avenir": [{ from: 2020, to: 2025, size: "235/50R19" }],
    },
    Envision: {
      "Preferred / Essence": [{ from: 2021, to: 2025, size: "235/55R19" }],
      "Avenir": [{ from: 2021, to: 2025, size: "245/45R20" }],
    },
    Enclave: {
      "Preferred / Essence": [{ from: 2018, to: 2025, size: "255/65R18" }],
      "Avenir": [{ from: 2018, to: 2025, size: "255/55R20" }],
    },
  },
  Chrysler: {
    "300": {
      "Touring": [{ from: 2015, to: 2023, size: "215/65R17" }],
      "300S / 300C": [{ from: 2015, to: 2023, size: "245/45R20" }],
    },
    Pacifica: {
      "Touring / Limited": [{ from: 2017, to: 2025, size: "235/65R17" }],
      "Pinnacle": [{ from: 2021, to: 2025, size: "245/50R20" }],
    },
  },
  Mitsubishi: {
    Mirage: {
      "ES / SE": [{ from: 2017, to: 2024, size: "175/55R15" }],
    },
    "Outlander Sport": {
      "ES / SE": [{ from: 2016, to: 2025, size: "215/70R16" }],
      "SEL / GT": [{ from: 2016, to: 2025, size: "225/55R18" }],
    },
    "Eclipse Cross": {
      "ES / SE": [{ from: 2018, to: 2025, size: "215/70R16" }],
      "SEL": [{ from: 2018, to: 2025, size: "225/55R18" }],
    },
    Outlander: {
      "ES / SE": [{ from: 2022, to: 2025, size: "235/60R18" }],
      "SEL": [{ from: 2022, to: 2025, size: "255/45R20" }],
    },
  },
  Mini: {
    "Cooper Hardtop": {
      "Cooper": [{ from: 2014, to: 2025, size: "195/55R16" }],
      "Cooper S / JCW": [{ from: 2014, to: 2025, size: "205/45R17" }],
    },
    Countryman: {
      "Cooper / S": [{ from: 2017, to: 2025, size: "225/55R18" }],
      "JCW": [{ from: 2017, to: 2025, size: "225/45R19" }],
    },
  },
  "Land Rover": {
    "Range Rover Evoque": {
      "S / SE": [{ from: 2020, to: 2025, size: "235/60R18" }],
      "Dynamic": [{ from: 2020, to: 2025, size: "245/45R20" }],
    },
    Defender: {
      "90 / 110": [{ from: 2020, to: 2025, size: "255/60R19" }],
      "X / V8": [{ from: 2020, to: 2025, size: "275/45R21" }],
    },
    Discovery: {
      "S / SE": [{ from: 2017, to: 2025, size: "255/60R19" }],
      "R-Dynamic / HSE": [{ from: 2017, to: 2025, size: "275/45R21" }],
    },
    "Range Rover Sport": {
      "SE / Dynamic": [{ from: 2018, to: 2025, size: "275/45R21" }],
      "Autobiography / SV": [{ from: 2018, to: 2025, size: "285/40R22" }],
    },
    "Range Rover": {
      "SE / HSE": [{ from: 2018, to: 2025, size: "255/55R20" }],
      "Autobiography / SV": [{ from: 2018, to: 2025, size: "285/40R23" }],
    },
  },
  Jaguar: {
    "E-PACE": {
      "P250 / P300": [{ from: 2018, to: 2025, size: "235/55R19" }],
      "R-Dynamic": [{ from: 2018, to: 2025, size: "245/45R20" }],
    },
    "F-PACE": {
      "P250 / P340": [{ from: 2017, to: 2025, size: "255/55R19" }],
      "R-Dynamic / SVR": [{ from: 2017, to: 2025, size: "265/45R21" }],
    },
    XF: {
      "P250 / P300": [{ from: 2016, to: 2025, size: "245/45R18" }],
      "R-Dynamic": [{ from: 2016, to: 2025, size: "255/35R20" }],
    },
    "F-TYPE": {
      "P450": [{ from: 2017, to: 2024, size: "255/35R20", rear: "295/30R20" }],
      "R / R75": [{ from: 2017, to: 2024, size: "265/35R20", rear: "305/30R20" }],
    },
  },
  Rivian: {
    R1T: {
      "Adventure / Launch": [{ from: 2022, to: 2025, size: "275/65R20" }],
      "Performance / Off-Road": [{ from: 2022, to: 2025, size: "275/55R21" }],
    },
    R1S: {
      "Adventure / Launch": [{ from: 2022, to: 2025, size: "275/65R20" }],
      "Performance / Off-Road": [{ from: 2022, to: 2025, size: "275/55R21" }],
  ...
  Polestar: {
    "Polestar 2": {
      "Standard / Long Range": [{ from: 2021, to: 2025, size: "245/45R19" }],
      "Performance": [{ from: 2021, to: 2025, size: "245/40R20" }],
    },
    "Polestar 3": {
      "Long Range": [{ from: 2024, to: 2025, size: "265/45R21" }],
      "Performance": [{ from: 2024, to: 2025, size: "265/40R22" }],
    },
  },
  "Alfa Romeo": {
    Giulia: {
      "Sprint / Ti": [{ from: 2017, to: 2025, size: "225/45R18", rear: "255/40R18" }],
      "Quadrifoglio": [{ from: 2017, to: 2025, size: "245/35R19", rear: "285/30R19" }],
    },
    Stelvio: {
      "Sprint / Ti": [{ from: 2018, to: 2025, size: "235/55R19" }],
      "Quadrifoglio": [{ from: 2018, to: 2025, size: "255/45R20", rear: "285/40R20" }],
    },
  },
  Maserati: {
    Ghibli: {
      "GT / Modena": [{ from: 2014, to: 2024, size: "245/45R19", rear: "275/40R19" }],
      "Trofeo": [{ from: 2021, to: 2024, size: "245/35R21", rear: "285/30R21" }],
    },
    Grecale: {
      "GT / Modena": [{ from: 2023, to: 2025, size: "255/45R20" }],
      "Trofeo": [{ from: 2023, to: 2025, size: "255/40R21", rear: "295/35R21" }],
    },
    Levante: {
      "GT / Modena": [{ from: 2017, to: 2024, size: "265/45R21" }],
      "Trofeo": [{ from: 2019, to: 2024, size: "265/40R22", rear: "295/35R22" }],
    },
  },
  Fiat: {
    "500X": {
      "Pop / Trekking": [{ from: 2016, to: 2023, size: "215/60R17" }],
      "Sport": [{ from: 2016, to: 2023, size: "225/45R19" }],
    },
    "500": {
      "Pop / Lounge": [{ from: 2012, to: 2019, size: "185/55R15" }],
      "Abarth": [{ from: 2012, to: 2019, size: "195/45R16" }],
    },
    "124 Spider": {
      "Classica / Lusso": [{ from: 2017, to: 2020, size: "195/50R16" }],
      "Abarth": [{ from: 2017, to: 2020, size: "205/45R17" }],
    },
  },
  Lucid: {
    Air: {
      "Pure / Touring": [{ from: 2022, to: 2025, size: "245/45R19" }],
      "Grand Touring / Sapphire": [{ from: 2022, to: 2025, size: "265/40R20", rear: "295/35R21" }],
    },
  },
  Scion: {
    "FR-S": {
      "Base": [{ from: 2013, to: 2016, size: "215/45R17" }],
    },
    tC: {
      "Base": [{ from: 2011, to: 2016, size: "225/45R18" }],
    },
    xB: {
      "Base": [{ from: 2008, to: 2015, size: "205/55R16" }],
    },
    iA: {
      "Base": [{ from: 2016, to: 2016, size: "185/60R16" }],
    },
  },
  Hummer: {
    "EV Pickup": {
      "Edition 1 / 3X": [{ from: 2022, to: 2025, size: "305/70R18" }],
    },
    "EV SUV": {
      "Edition 1 / 3X": [{ from: 2024, to: 2025, size: "305/70R18" }],
    },
  },
};
