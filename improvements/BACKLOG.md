...
| 10 | Link `app/sizes/[size]` to `/guide` + FAQ block for parity with `app/tires/[brand]` (dwell/SEO/trust) | acquisition / SEO | marketing-reports/2026-07-06 (A3) | none | pending |
